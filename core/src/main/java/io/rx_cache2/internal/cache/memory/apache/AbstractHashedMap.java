...
public class AbstractHashedMap<K, V> extends AbstractMap<K, V> implements IterableMap<K, V> {
     ...
     */
    protected static class HashMapIterator<K, V> extends HashIterator<K, V> implements
    ...
    protected Iterator<V> createValuesIterator() {
        if (size() == 0) {
            return io.rx_cache2.internal.cache.memory.apache.EmptyIterator.<V>emptyIterator();
        }
    ...
    public boolean equals(final Object obj) {
        ...
        final io.rx_cache2.internal.cache.memory.apache.MapIterator<?,?> it = mapIterator();
        try {
            while (it.hasNext()) {
    ...
    public String toString() {
        ...
        final io.rx_cache2.internal.cache.memory.apache.MapIterator<K, V> it = mapIterator();
